...
import { Clock, Flag, ChevronLeft, ChevronRight, CheckCircle, AlertCircle, Info } from 'lucide-react';
                  ...
                  {currentQ.options.map((opt) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`text-sm leading-snug ${isSelected ? 'text-slate-900 font-semibold' : 'text-slate-700'}`}>
                          {opt.text}
                        </span>
                      </div>
                    );
