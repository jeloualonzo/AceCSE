...
export const PracticePage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6">
      <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900">Practice</h1>
      ...
      <section aria-labelledby="subjects-heading" className="space-y-3">
        <h2 id="subjects-heading" className="text-sm font-bold uppercase tracking-wider text-slate-500">
          Choose Subjects
        </h2>
